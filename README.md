...
Atualmente estou aprofundando meus conhecimentos em **Java**, dominando **Orientação a Objetos (POO)**, Lógica de Programação e Estruturas de Dados para construir sistemas backend bem arquitetados e eficientes.
...
- 🧠 **Fundamentos Fortes:** Orientação a Objetos, Encapsulamento, Coleções e Tratamento de Exceções.
- 💻 **Projetos Práticos:** Aplicação de conceitos em projetos reais via terminal e consumo de APIs REST.
- 🗺️ **Próximos Passos:** Banco de Dados (SQL/JPA) e o ecossistema **Spring Boot**.
